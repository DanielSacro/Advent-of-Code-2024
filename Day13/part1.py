...
def play(machine):
    ...
    X = int(prize_inputs[0][2:-1])
    Y = int(prize_inputs[1][2:])
    ...
    B = round(B, 5) # Because some integers represented as X.0000000001 and not as X.0
    ...
    if not A.is_integer() or not B.is_integer():
        ...
        # Don't press buttons more than 100 times
        print(A, B)
        return 0
    elif A < 0 or B < 0:
